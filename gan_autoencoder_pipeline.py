...
Maps 5 original classes into 3 groups: Normal, Benign, Malignant
"""
...
# Map original 5 classes to 3 groups
train_dataset.targets = [class_mapping[train_dataset.classes[i]] for i in train_dataset.targets]
test_dataset.targets  = [class_mapping[test_dataset.classes[i]]  for i in test_dataset.targets]

train_loader = DataLoader(train_dataset, batch_size=32, shuffle=True)
test_loader  = DataLoader(test_dataset, batch_size=32, shuffle=False)

# -----------------------------
# GAN (Simple MLP for demonstration)
# -----------------------------
